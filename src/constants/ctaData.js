// constants/ctaData.js

export const ctaData = {
  header: {
    // Hidden SEO text for bots
    seoTitle: "Contact DIV for Enterprise Software Solutions",
    
    // Visual text for humans
    visualHighlight: "Let's Talk!",
    visualText: "We're Here To Help."
  },
